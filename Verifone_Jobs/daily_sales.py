...
if response.status_code == 200:
    ...
    if cookie_element is not None:
        ...
        # for reptnum in range(1, 50):
        # for reptnum in range(698, 710):
            # Second link
            ...
            if response_2.status_code == 200:
                ...
                # Skip Sapphire / error responses
                if NAXML_NS not in root_2.tag:
                    print(f"Skipping reptnum {reptnum}: Not a NAXML report")
                    continue
                # ✅ END BLOCK
                ...
                data = {
                    "StoreLocationID": get_text(root_2, './/nax:StoreLocationID', ns),
                    "corpid": corpid,
                    "storeid": storeid,
                    "ReportSequenceNumber": get_text(root_2, './/nax:ReportSequenceNumber', ns),
                    "BeginDate": get_text(root_2, './/nax:BeginDate', ns),
                    "BeginTime": get_text(root_2, './/nax:BeginTime', ns),
                    "EndDate": get_text(root_2, './/nax:EndDate', ns),
                    "EndTime": get_text(root_2, './/nax:EndTime', ns),
                }
